...
4. **Scaffold Missing Context**: If `docs/specs/` does not exist, invoke the **spec**
   skill first. Never architect without durable requirements.
...
| Database / Storage | ... | ... |
| API / Transport | ... | ... |
| Styling / Design Tokens | ... | (Owned by design-system skill) |
